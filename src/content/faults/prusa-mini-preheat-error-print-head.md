...
image: "./img/prusa-mini.png"
image_alt: "Line-art illustration of the Prusa MINI 3D printer showing its single Z column, print head and front control screen"
...
cover normal room temperatures. The heater goes on the 200 Ω range: Prusa's published figure for the MINI's
hot-end heater is **12.3 Ω to 15.1 Ω** — the same window Prusa quotes for the
MK3, MK4, XL and CORE One. A reading inside that band is normal; an open
circuit identifies the failed side outright.
